...
const dict: Record<string, { en: string; ar: string }> = {
  ...
  "share.searchPlaceholder": { en: "Search by name or email...", ar: "ابحث بالاسم أو البريد..." },
  ...
  "share.enableLinkHint": { en: "Anyone with the link can join this project", ar: "أي شخص معه الرابط يمكنه الانضمام إلى المشروع" },
  ...
  "share.linkSummary": {
    ...
    ar: "أي شخص معه هذا الرابط يمكنه الانضمام إلى {project} بصلاحية {role}.",
  },
  ...
  "share.invitedHeadline": { en: "You're invited to join {project} on Viora", ar: "أنت مدعوّ للانضمام إلى {project} على فيورا" },
  ...
  "board.menu.searchMembers": { en: "Search members...", ar: "ابحث عن الأعضاء..." },
  ...
  "board.menu.fileTooLarge": { en: "File is larger than 1.5 MB and was skipped", ar: "الملف أكبر من 1.5 ميجابايت وتم تخطيه" },
