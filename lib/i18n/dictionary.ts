...
const dict: Record<string, { en: string; ar: string }> = {
  ...
  "files.emptyHint": { en: "Uploaded project files will appear here.", ar: "الملفات المرفوعة للمشروع هتظهر هنا." },
  "nav.reports": { en: "Reports", ar: "التقارير" },
  "nav.rooms": { en: "Rooms", ar: "الغرف" },
  "nav.settings": { en: "Settings", ar: "الإعدادات" },
  "comingSoon.hint": {
    en: "This page will be designed next from the screenshot you send.",
    ar: "الصفحة دي هتتصمم بعدين من الصورة اللي هتبعتها.",
  },
