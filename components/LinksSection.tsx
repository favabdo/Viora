...
const TAG_COLORS = ["#2563EB", "#3B82F6", "#22C55E", "#F59E0B", "#0891B2", "#10B981", "#EF4444"];
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between mb-5">
        <div>
          <h1 className="flex items-center gap-2 text-[26px] font-semibold tracking-tight text-ink">
            <Paperclip size={22} className="text-[#2563EB]" />
            {t("links.pageTitle")}
          </h1>
                            ...
                            <div className="flex items-start gap-3">
                              ...
                              <div className="hidden sm:flex flex-col items-end gap-1 shrink-0 text-[11px] text-inkFaint">
                                ...
                                <span className="inline-flex items-center gap-1">
                                  <Bookmark
                                    size={14}
                                    className={link.is_done ? "text-[#2563EB]" : ""}
                    ...
                    .map((n) => (
                      <button
                        ...
                        className={`h-8 min-w-8 px-2 rounded-lg text-xs ${
                          n === currentPage ? "bg-[#2563EB] text-white" : "border border-line text-inkSoft"
                        }`}
                      >
                        {n}
                      </button>
              ...
              {editing ? (
                ...
                <>
                  ...
                  <a
                    ...
                    className="mt-1 inline-flex items-center gap-1 text-xs text-[#2563EB] break-all"
                    dir="ltr"
                  >
                    {selected.url}
                  ...
                  <div className="flex items-center gap-2 mt-4">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="flex-1 inline-flex items-center justify-center gap-1.5 rounded-lg bg-[#2563EB] hover:bg-[#1E40AF] text-white text-sm font-medium py-2"
                    >
                      {t("links.openLink")}
                    </a>
