...
const OVERVIEW = [
  { id: "todo", color: "#2563EB", labelKey: "home.todo" },
...
const PRIORITY = [
  ...
  { id: "medium", color: "#3B82F6", labelKey: "home.medium" },
    ...
    <>
      ...
      <div className="min-w-0 space-y-4 sm:space-y-5">
        ...
        <div className="grid grid-cols-2 xl:grid-cols-5 gap-2.5 sm:gap-3">
          <StatCard title={t("home.totalProjects")} value={scopedProjects.length} change={pctChange(projectsNow, projectsPrev)} color="#2563EB" Icon={FolderKanban} spark={sparkProjects} vs={t("home.vsPrev")} />
        ...
        <Panel title={t("home.activityOverview")}>
          <AreaChart
            ...
            series={[
              ...
              { label: t("home.files"), color: "#3B82F6", values: countsForDays(files.map((row) => row.created_at), keys) },
            ]}
          />
        </Panel>
      </div>
