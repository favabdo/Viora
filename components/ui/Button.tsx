...
const variants: Record<Variant, string> = {
  primary:
    "text-white bg-gradient-to-r from-[#3B82F6] via-[#2563EB] to-[#1D4ED8] shadow-[0_8px_22px_-8px_rgba(37, 99, 235,0.85)] hover:shadow-[0_12px_28px_-6px_rgba(37, 99, 235,0.95)] hover:-translate-y-0.5",
