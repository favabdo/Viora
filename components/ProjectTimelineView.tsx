...
const BAR_COLORS = ["#EA580C", "#22C55E", "#3B82F6", "#C4A574", "#F59E0B", "#14B8A6", "#EC4899"];
          ...
          <div style={{ minWidth: LABEL_WIDTH + gridWidth }}>
            ...
            <div className="relative">
              ...
              {todayOffset >= 0 && todayOffset < totalDays && (
                ...
                >
                  <div className="absolute -top-0 -translate-x-1/2 rounded-md bg-[#EA580C] px-1.5 py-0.5 text-[9px] text-white whitespace-nowrap">
                ...
                return (
                  <div
                    ...
                    className={`flex items-center border-b cursor-pointer ${
                      isSelected ? "border-line bg-[#EA580C]/[0.06]" : "border-line/70 hover:bg-paperDark/60"
                    }`}
                  ...
                  >
                    <div
                      className={`shrink-0 sticky start-0 z-[5] px-3 flex items-center gap-2 border-e border-line ${
                        isSelected ? "bg-[#EA580C]/[0.06]" : "bg-surface"
                      }`}
              ...
              {adding ? (
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-8 py-2.5 text-xs text-inkFaint hover:text-[#EA580C] border-b border-line w-full text-start"
                >
                  <Plus size={13} />
                  {t("list.addTask")}
                </button>
