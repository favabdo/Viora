        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between gap-3">
            ...
            <button
              ...
              className={`relative h-6 w-11 rounded-full transition-colors ${linkEnabled ? "bg-[#2563EB]" : "bg-lineStrong"}`}
            >
              <span
          ...
          <div className={linkEnabled ? "" : "opacity-50 pointer-events-none"}>
            ...
            <div className="mt-4 flex items-start gap-2 rounded-xl bg-[#2563EB]/10 px-3 py-2.5 text-xs text-inkSoft leading-relaxed">
