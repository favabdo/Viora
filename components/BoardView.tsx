...
const COLUMN_PALETTE = ["#3b82f6", "#0891B2", "#22c55e", "#3B82F6", "#ef4444", "#059669", "#eab308", "#6b7280"];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-1.5 mt-2 flex-wrap">
        ...
        {extras.category && (
          <span className="text-[10px] font-medium px-1.5 py-0.5 rounded bg-[#2563EB]/15 text-[#1E40AF] dark:text-[#BFDBFE]">
        ...
        {extras.pinned && <Pin size={11} className="text-[#2563EB]" />}
  ...
  return (
    <div
      ...
      className={`flex flex-col w-[280px] h-full min-h-0 shrink-0 rounded-xl border p-3 transition-colors ${
        isOver ? "border-[#2563EB] bg-[#2563EB]/10" : "border-line bg-surface"
      }`}
    >
      <div className="flex items-center gap-2 mb-3 px-0.5 shrink-0">
        ...
        {editingName ? (
          <input
            ...
            className="flex-1 min-w-0 bg-transparent text-sm font-semibold text-ink focus:outline-none border-b border-[#2563EB]"
          />
        ) : (
          <button
            onClick={() => {
            ...
            className="flex-1 min-w-0 text-start text-sm font-semibold text-ink truncate hover:text-[#2563EB] transition-colors"
          >
            {column.name}
          </button>
        )}
      ...
      <button
        ...
        className="flex items-center gap-1.5 mt-2 shrink-0 px-2 py-2 text-xs text-inkFaint hover:text-[#2563EB] rounded-md border border-transparent hover:border-dashed hover:border-[#2563EB] transition-colors"
      >
    ...
    >
      <div className="flex items-center justify-end mb-3">
        <button
          ...
          className="inline-flex items-center gap-1.5 rounded-lg bg-[#2563EB] px-3.5 py-2 text-sm font-medium text-white hover:bg-[#1D4ED8] active:bg-[#1E40AF] transition-colors"
        >
        ...
        <div className="w-[280px] h-full shrink-0 rounded-xl border border-dashed border-line bg-paperDark/60 p-3">
          {showAddColumn ? (
                ...
                <div className="flex flex-wrap gap-1.5">
                  {COLUMN_PALETTE.map((color) => (
                    <button
                      ...
                      className={`h-5 w-5 rounded-full border ${newColumnColor === color ? "ring-2 ring-offset-1 ring-[#2563EB] border-transparent" : "border-line"}`}
            ...
            <button
              ...
              className="flex items-center gap-1.5 px-2.5 py-1.5 text-sm text-inkFaint hover:text-[#2563EB] hover:bg-paperDark rounded-lg transition-colors w-full"
            >
      ...
      <DragOverlay>
        {activeTask ? (
          <div className="bg-surface border border-[#2563EB] rounded-lg p-3 shadow-modal w-72 opacity-90">
